...
class BankTablePagebu extends StatefulWidget {
  @override
  _BankTablePage1Statebu createState() => _BankTablePage1Statebu();
}

class _BankTablePage1Statebu extends State<BankTablePagebu> {
  late String _selectedBank = '';

  List<Map<String, dynamic>> _banks = [
    {'name': 'Axis bank', 'rate': 1.00},
    {'name': 'ICICI bank', 'rate': 14.50},
