...
class BankTablePageve extends StatefulWidget {
  @override
  _BankTablePageStateve createState() => _BankTablePageStateve();
}

class _BankTablePageStateve extends State<BankTablePageve> {
