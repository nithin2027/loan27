...
class BankTablePageveh extends StatefulWidget {
  @override
  _BankTablePageStateveh createState() => _BankTablePageStateveh();
}

class _BankTablePageStateveh extends State<BankTablePageveh> {
  late String _selectedBank = '';

  List<Map<String, dynamic>> _banks = [
    {'name': 'State bank of India', 'rate': 8.00},
    {'name': 'Bank of Baroda', 'rate': 8.50},
    {'name': 'Canara bank', 'rate': 8.95},
    {'name': 'Karnataka bank', 'rate': 8.75},
    {'name': 'Bank of India', 'rate': 9.05},
  ];
