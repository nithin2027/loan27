...
import 'package:loan27/dashboard/dashboardhou.dart';
import 'package:loan27/details.dart';
import 'dart:convert';
import 'package:http/http.dart' as http;

class UserDetailsPage4 extends StatefulWidget {
  UserDetailsPage4({Key? key}) : super(key: key);

  @override
  _UserDetailsPage4State createState() => _UserDetailsPage4State();
}

class _UserDetailsPage4State extends State<UserDetailsPage4> {
  ...
  final List<String> _propertystatusList = [
    'Under construction',
  ...
  Future<void> save() async {
    var url = Uri.parse("http://10.0.2.2:8383/house");
  ...
  int income = 0; // Separate variable for income
  House house = House('', '', '', '', '', '', '', '', '', 0);
  @override
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                DropdownButtonFormField<String>(
                  decoration: InputDecoration(labelText: 'propertytype'),
                  value: _propertytype,
                  onChanged: (String? value) {
                    setState(() {
                      _propertytype = value!;
                  ...
                  items: _propertytypeList.map((String occupation) {
                    return DropdownMenuItem<String>(
                      value: occupation,
                      child: Text(occupation),
                    );
                ...
                DropdownButtonFormField<String>(
                  decoration: InputDecoration(labelText: 'propertystatus'),
                  ...
                  items: _propertystatusList.map((String occupation) {
                    return DropdownMenuItem<String>(
                      value: occupation,
                      child: Text(occupation),
                    );
  ...
  void _showDialog() {
    showDialog(
        ...
        builder: (BuildContext context) {
          return AlertDialog(
            title: Text('HOUSING LOAN Details'),
            content: Column(
              ...
              children: <Widget>[
                ...
                SizedBox(height: 8.0),
                Text('Property Type: $_propertytype'),
                SizedBox(height: 8.0),
                Text('Property status: $_propertystatus'),
                SizedBox(height: 8.0),
                Text('INCOME : $_income'),
              ],
            ),
