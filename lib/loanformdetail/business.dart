...
import 'package:loan27/dashboard/dashboardbus.dart';
import 'package:loan27/details.dart';
import 'dart:convert';
import 'package:http/http.dart' as http;

class UserDetailsPage2 extends StatefulWidget {
  UserDetailsPage2({Key? key}) : super(key: key);
...
class _UserDetailsPage2State extends State<UserDetailsPage2> {
  ...
  final List<String> _companytypeList = [
    'Partnership',
    'LLP',
    'Proprietorship',
    'Private Limited',
  ...
  Future<void> save() async {
    var url = Uri.parse("http://10.0.2.2:8383/business");
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                SizedBox(height: 16.0),
                DropdownButtonFormField<String>(
                  decoration: InputDecoration(labelText: 'companytype'),
                  value: _companytype,
                  onChanged: (String? value) {
                    setState(() {
                      _companytype = value!;
                  ...
                  items: _companytypeList.map((String occupation) {
                    return DropdownMenuItem<String>(
                      value: occupation,
          ...
          return AlertDialog(
            ...
            content: Column(
              ...
              children: <Widget>[
                ...
                Text('Gender: $_gender'),
                SizedBox(height: 8.0),
                Text('Company Type: $_companytype'),
                SizedBox(height: 8.0),
