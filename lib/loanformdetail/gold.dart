...
import 'package:loan27/dashboard/dashboard.dart';
import 'package:loan27/details.dart';
import 'dart:convert';
import 'package:http/http.dart' as http;

class UserDetailsPage6 extends StatefulWidget {
  UserDetailsPage6({Key? key}) : super(key: key);

  @override
  _UserDetailsgoldState createState() => _UserDetailsgoldState();
}

class _UserDetailsgoldState extends State<UserDetailsPage6> {
  ...
  Future<void> save() async {
    var url = Uri.parse("http://10.0.2.2:8383/gold");
        ...
        return AlertDialog(
          ...
          content: Column(
            ...
            children: <Widget>[
              ...
              SizedBox(height: 8.0),
              // Text('Date of Birth: ${_dob?.day}/${_dob?.month}/${_dob?.year}'),
              // SizedBox(height: 8.0),
