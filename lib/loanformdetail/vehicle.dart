...
import 'package:loan27/dashboard/dashboardveh.dart';
import 'package:loan27/details.dart';
import 'dart:convert';
import 'package:http/http.dart' as http;

class UserDetailsPage5 extends StatefulWidget {
  UserDetailsPage5({Key? key}) : super(key: key);

  @override
  _UserDetailsPage5State createState() => _UserDetailsPage5State();
}

class _UserDetailsPage5State extends State<UserDetailsPage5> {
  ...
  Future<void> save() async {
    var url = Uri.parse("http://10.0.2.2:8383/vehicle");
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        centerTitle: true,
        title: Text('VEHICLE LOAN DETAILS'),
        leading: BackButton(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                DropdownButtonFormField<String>(
                  ...
                  items: _vehicletypeList.map((String occupation) {
                    return DropdownMenuItem<String>(
                      value: occupation,
                      child: Text(occupation),
                    );
